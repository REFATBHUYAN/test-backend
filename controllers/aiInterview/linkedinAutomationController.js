...
// working locally with playwrite
...
class EnhancedLinkedInAutomation {
  ...
  try {
    ...
    // Use the browser manager instead of direct chromium.launch
    this.browser = await browserManager.launchBrowser({ chromium }, {
      headless: config.headless,
      slowMo: config.slowMo,
      devtools: config.devtools,
      args: [
...
export default EnhancedLinkedInAutomation
...
//   production: {
//     headless: true,
//     slowMo: 500, // Still some delay to appear human
//     devtools: false,
//   },
// }
...
//     console.log("🔐 Attempting LinkedIn login with stealth mode...");
...
//       // Emit to frontend for user input
...
//               const inputSelector = emailVerification 
//                 ? 'input[name="pin"]' 
//                 : 'input[name="pin"]';
...
//       const captchaChallenge = await this.page.locator('[data-test-id="captcha-internal"]').isVisible();
      
//       if (captchaChallenge) {
//         console.log("🤖 CAPTCHA challenge detected - manual intervention required");
        
//         return new Promise((resolve) => {
//           const { io } = require("../../index.js");
          
//           io.emit("linkedinManualIntervention", {
//             type: "captcha",
...
//               this.isLoggedIn = true;
//               resolve({ success: true, message: "Manual intervention successful" });
//             }
//           }, 10000);
...
//           setTimeout(() => {
//             clearInterval(checkProgress);
//             resolve({ success: false, message: "Manual intervention timeout" });
//           }, 5 * 60 * 1000);
//         });
//       }
//     }
...
// export const extractLinkedInProfileAutomation = async (req, res) => {
//   try {
//     const profileUrl = "https://www.linkedin.com/in/md-mottakin-rahat/"
//     // const { profileUrl } = req.body;
