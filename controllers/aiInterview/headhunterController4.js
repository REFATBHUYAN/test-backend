...
function emitProgress2(searchId, status, progress, candidatesFound = 0, platform = "", canStop = true) {
  const progressData = {
    searchId,
    status,
...
async function checkLinkedInExtractionComplete2(searchId) {
  try {
...
async function continueSearchAfterLinkedInExtraction2(searchId, linkedinCandidates, wasStopped = false) {
  try {
