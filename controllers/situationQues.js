...
export const situationQues = async (req, res) => {
    const { jd } = req.body;
    ...
    try {
        ...
        const prompt = PromptTemplate.fromTemplate(
            ...
            Provide a set of situational-based questions along with the format and instructions for the candidate to complete the test.
